...
(defun plantuml-init-once ()
  ...
  (unless plantuml-kwdList
    ...
    (defvar pkg-plantuml-indent-regexp-end ".*\\(}\\|endif\\|}\\|end\\).*$")
...
\\[plantuml-complete-symbol]      `plantuml-complete-symbol'"
  ...
  ;; (set (make-local-variable 'indent-line-function) 'plantuml-current-block-depth)
  (setq font-lock-defaults '((plantuml-font-lock-keywords) nil t))

  (add-hook 'after-save-hook 'plantuml-hook-fun nil t)
  )
